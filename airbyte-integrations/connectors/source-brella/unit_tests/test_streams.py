...
import pytest
from source_brella.source import BrellaStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(BrellaStream, "path", "v0/example_endpoint")
    mocker.patch.object(BrellaStream, "primary_key", "test_primary_key")
    mocker.patch.object(BrellaStream, "__abstractmethods__", set())
